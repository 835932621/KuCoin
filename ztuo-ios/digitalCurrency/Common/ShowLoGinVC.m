...
//  BaseProject
//
//  Created by YLCai on 2019/6/15.
//  Copyright © 2019年 YLCai. All rights reserved.
//
...
+(void)showLoginVc:(UIViewController *)vc withTipMessage:(NSString *)tipMessage{
    ...
    UIAlertAction *action1 = [UIAlertAction actionWithTitle:LocalizationKey(@"确认") style:UIAlertActionStyleDestructive handler:^(UIAlertAction * _Nonnull action) {
