...
// 以下合约socket获取数据指令
static  short  CONTRACT_SUBSCRIBE_SYMBOL_THUMB = 20001; //订阅缩略行情
static  short  CONTRACT_PUSH_SYMBOL_THUMB = 20003; //推送币种行情
static  short  SUBSCRIBE_EXCHANGE_TRADE_CONTRACT = 20021; //订阅交易信息（盘口，K线、成交明细）   盘口信息 
static  short  UNSUBSCRIBE_EXCHANGE_TRADE_CONTRACT = 20022; //取消订阅交易信息（盘口，K线、成交明细）   盘口信息 
static  short  CONTRACT_PUSH_EXCHANGE_PLATE = 20024; //推送盘口数据 
static  short  CONTRACT_UNSUBSCRIBE_SYMBOL_THUMB = 20002; //取消订阅行情 
static  short  CONTRACT_PUSH_EXCHANGE_TRADE = 20023; //推送交易明细
static  short  CONTRACT_PUSH_EXCHANGE_ORDER_TRADE = 20028; //推送订单成交信息（指定用户） 
static  short  CONTRACT_PUSH_EXCHANGE_DEPTH = 20029; //推送订单成交信息（指定用户） 
static  short  CONTRACT_PUSH_EXCHANGE_KLINE =20025; //推送K线    
static  short  CONTRACT_PUSH_EXCHANGE_ORDER_COMPLETED =20026; // 指令：推送订单完
static  short  CONTRACT_PUSH_EXCHANGE_ORDER_CANCELED =20027; // / 指令：推送订单取消信息（指定用户）
