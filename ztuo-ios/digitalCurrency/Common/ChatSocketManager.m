...
//static  NSString * s_host = @"39.104.106.202";//
...
//    NSLog(LocalizationKey(@"聊天类socket连接成功"));
...
//    NSLog(LocalizationKey(@"聊天类socket断开连接--出错--%@"),[err description]);
    //[APPLICATION.window makeToast:LocalizationKey(@"聊天类socket断开连接") duration:5.5 position:CSToastPositionCenter];
