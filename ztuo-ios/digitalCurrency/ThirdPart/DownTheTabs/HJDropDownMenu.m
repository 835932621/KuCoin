...
#define dropBackColor  RGBOF(0x1F2833)
...
- (void)setupUI{
    ...
    [self.listTable setFrame:CGRectMake(0, 0, 200, self.rowHeight)];
...
//        _listTable.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 100, 0.0001f)];
//      _listTable.tableFooterView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kScreenSize.width, 0.0001f)];
...
- (UIButton *)headerBtn{
    if (!_headerBtn) {
        ...
        [_headerBtn setBackgroundColor:dropBackColor];//dropBackColor
        ...
        [_headerBtn setTitleEdgeInsets:UIEdgeInsetsMake(0, 18, 0, 0)];
