...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _openLabel.textColor = kRGBColor(102, 102, 102);
        _highLabel.textColor = kRGBColor(102, 102, 102);
        _lowLabel.textColor = kRGBColor(102, 102, 102);
        _closeLabel.textColor = kRGBColor(102, 102, 102);
