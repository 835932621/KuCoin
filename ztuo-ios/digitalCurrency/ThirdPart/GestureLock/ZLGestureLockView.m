...
- (void)initSubviews {
    ...
    for (NSInteger i = 0; i < 9; i++) {
        ...
        [btn setBackgroundImage:[UIImage imageNamed:LocalizationKey(@"未选")] forState:UIControlStateNormal];
        [btn setBackgroundImage:[UIImage imageNamed:LocalizationKey(@"选中")] forState:UIControlStateSelected];
        [self addSubview:btn];
        btn.tag = i + 1;
    }
}
