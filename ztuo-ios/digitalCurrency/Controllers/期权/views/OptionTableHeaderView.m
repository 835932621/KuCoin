...
- (Y_StockChartView *)stockChartView
{
    if(!_stockChartView) {
        ...
        _stockChartView.itemModels = @[
            [Y_StockChartViewItemModel itemModelWithTitle:LocalizationKey(@"指标") type:Y_StockChartcenterViewTypeOther],
            [Y_StockChartViewItemModel itemModelWithTitle:LocalizationKey(@"分时") type:Y_StockChartcenterViewTypeTimeLine],
            [Y_StockChartViewItemModel itemModelWithTitle:LocalizationKey(@"1分") type:Y_StockChartcenterViewTypeKline],
            [Y_StockChartViewItemModel itemModelWithTitle:LocalizationKey(@"5分") type:Y_StockChartcenterViewTypeKline],
            [Y_StockChartViewItemModel itemModelWithTitle:LocalizationKey(@"1小时") type:Y_StockChartcenterViewTypeKline],
            [Y_StockChartViewItemModel itemModelWithTitle:LocalizationKey(@"1天") type:Y_StockChartcenterViewTypeKline],
            [Y_StockChartViewItemModel itemModelWithTitle:LocalizationKey(@"15分") type:Y_StockChartcenterViewTypeKline],
            [Y_StockChartViewItemModel itemModelWithTitle:LocalizationKey(@"30分钟") type:Y_StockChartcenterViewTypeKline],
            [Y_StockChartViewItemModel itemModelWithTitle:LocalizationKey(@"1周") type:Y_StockChartcenterViewTypeKline],
            [Y_StockChartViewItemModel itemModelWithTitle:LocalizationKey(@"1月") type:Y_StockChartcenterViewTypeKline],
        ];
