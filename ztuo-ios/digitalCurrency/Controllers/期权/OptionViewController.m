...
@interface OptionViewController ()<UITableViewDelegate,UITableViewDataSource,SocketDelegate>
...
- (UITableView *)myTableView {
    if (!_myTableView) {
        if (!_myTableView) {
            _myTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 40, 0, 0) style:UITableViewStyleGrouped];
