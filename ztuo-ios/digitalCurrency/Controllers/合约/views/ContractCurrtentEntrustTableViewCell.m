...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        [self.contentView addSubview:self.mtitilelabel];
...
//        [self.revokebtn addTarget:self action:@selector(chexiaobtnclick) forControlEvents:UIControlEventTouchUpInside];
       ...
       [self.revokebtn mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        [self.contentView addSubview:_entrustTypetiplabel];
        ...
        [self.contentView addSubview:_triggertiplabel];
        ...
        [self.contentView addSubview:_entrusttiplabel];
        ...
        [self.contentView addSubview:self.entrustTypeStrlabel];
        ...
        [self.contentView addSubview:self.triggerPricelabel];
        ...
        [self.contentView addSubview:_dealtiplabel];
        ...
        [self.contentView addSubview:_deposittiplabel];
        ...
        [self.contentView addSubview:_entrustnumbertiplabel];
        ...
        [self.contentView addSubview:self.depositPricelabel];
        ...
        [self.contentView addSubview:self.entrustNumberlabel];
        ...
        self.entrustTypeStrlabel.text=LocalizationKey(@"限价委托");
        ...
        self.entrustNumberlabel.text=LocalizationKey(@"1张");
