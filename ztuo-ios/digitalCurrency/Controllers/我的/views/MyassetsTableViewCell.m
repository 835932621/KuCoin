...
- (void)awakeFromNib {
    ...
    self.titleview.text = LocalizationKey(@"资产管理");
...
//    NSArray *imagearray = @[@"wd_zc",@"wd_zcls",@"wd_jywk",@"wd_cbfh",@"wd_blc",LocalizationKey(@"图层 633")];
    NSArray *namearray = @[LocalizationKey(@"Myassets"),LocalizationKey(@"Assetflow"),/*LocalizationKey(@"collectionSettings"),*/LocalizationKey(@"fundPwd")];
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath{
    return CGSizeMake(self.collectionview.width /item_count,self.collectionview.width /4 + 10);
}
