...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        [self.myInvitationBtn setTitle:LocalizationKey(LocalizationKey(@"我的邀请链接")) forState:UIControlStateNormal];
        ...
        self.tiplabel1.text=LocalizationKey(LocalizationKey(@"一级好友"));
        ...
        self.mtitlelabel.text=LocalizationKey(LocalizationKey(@"我的邀请"));
        self.titlelabel1.text=@"0";
        self.titlelabel2.text=@"0";
        self.titlelabel3.text=@"0.0";
        self.titlelbal4.text=@"LV0";
        self.tiplabel1.text=LocalizationKey(LocalizationKey(@"一级好友"));
        self.tiplabel2.text=LocalizationKey(LocalizationKey(@"二级好友"));
        self.tiplabel3.text=LocalizationKey(LocalizationKey(@"佣金收入"));
        self.tiplabel4.text=LocalizationKey(LocalizationKey(@"合伙级别"));
