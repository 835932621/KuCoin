...
@interface WalletManageContractTableViewCell()

@property(nonatomic, weak) UILabel *tiplabel1;
@property(nonatomic, weak) UILabel *tiplabel2;
@property(nonatomic, weak) UILabel *tiplabel3;
@property(nonatomic, weak) UILabel *tiplabel4;
...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        _mtitlelabel.text=LocalizationKey(@"BTC/USDT  永续账户");
...
-(void)setYongXuData{
    self.tiplabel1.text = LocalizationKey(@"Account_rights");
    self.tiplabel2.text = LocalizationKey(@"may_money");
    self.tiplabel3.text = LocalizationKey(@"use_money");
    self.tiplabel4.text = LocalizationKey(@"freeze_money");
}

-(void)setMiaoHeYueData:(NSDictionary *)dic{
    self.mtitlelabel.text = @"USDT";
    self.onelabel.text = [NSString stringWithFormat:@"%.4f", [dic[@"balance"] floatValue]];
    
    self.twolabel.text = @"";
    self.threelabel.text = @"";
    self.fourlabel.text = @"";
    
    self.tiplabel1.text = LocalizationKey(@"可用");
    self.tiplabel2.text = @"";
    self.tiplabel3.text = @"";
    self.tiplabel4.text = @"";
}
