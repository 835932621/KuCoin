...
//  Copyright © 2019年 BBING. All rights reserved.
//
...
//    [self.scrollView addSubview:kefu];
    ...
    kefuLabel.text = [NSString stringWithFormat:@"BBING %@：service@BBING.com",LocalizationKey(@"email")] ;
...
//    [self.scrollView addSubview:qunLabel];*/
    ...
    self.scrollView.contentSize = CGSizeMake(kWindowW, CGRectGetMaxY(about.frame) + 50);
}
