...
- (void)initData{
    ...
    _source = [NSString stringWithFormat:@"%@  KuCoin%@",time,LocalizationKey(@"exchange")];
...
- (void)getData{
    ...
    [[XBRequest sharedInstance] postDataWithUrl:url Parameter:param ResponseObject:^(NSDictionary *responseResult) {
        ...
        if (![responseResult objectForKey:@"resError"]) {
            ...
            _source = [NSString stringWithFormat:@"%@  KuCoin %@",data[@"createTime"],LocalizationKey(@"exchange")];
