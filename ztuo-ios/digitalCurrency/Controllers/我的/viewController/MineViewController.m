...
- (void)viewDidLoad {
    ...
    self.headerView.safebutton.hidden = YES;
    ...
    /* 屏蔽掉我的邀请这一块
        ...
        if (self.promotionDict&&self.promotionDict.allKeys.count!=0) {
            ...
            if ([YLUserInfo isLogIn]) {
                ...
                cell.titlelabel1.text=[NSString stringWithFormat:@"%@",self.promotionDict[@"levelOne"]];
                cell.titlelabel2.text=[NSString stringWithFormat:@"%@",self.promotionDict[@"levelTwo"]];
        ...
        cell.title.text = LocalizationKey(@"online_service");
        cell.title1.text = LocalizationKey(@"Click to enter");
        return cell;
    }
    else if (indexPath.section == 2){
        CurrencyexchangeTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"CurrencyexchangeTableViewCell" forIndexPath:indexPath];
        cell.title.text = LocalizationKey(@"personal_center");
        cell.title1.text = LocalizationKey(@"Click to enter");
        return cell;
    }
    else{
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 1) { //跳转客服
        
        WebViewController *vc = [WebViewController new];
        vc.urlStr = @"https://wa.me/353899518238"; //@"https://chatlink123.meiqia.cn/widget/standalone.html?eid=424a1dcc220c7f9b518b2eb83cf09adf";
        [[AppDelegate sharedAppDelegate] pushViewController:vc];
        
//        UITabBarController *tabbar = (UITabBarController*)[AppDelegate sharedAppDelegate].window.rootViewController;
