...
-(void)selectCoinTypeView{
    NSArray *zhBankName = @[LocalizationKey(@"中国工商银行"),LocalizationKey(@"中国农业银行"),LocalizationKey(@"中国建设银行"),LocalizationKey(@"中国邮政储蓄银行"),LocalizationKey(@"招商银行"),LocalizationKey(@"中国银行"),LocalizationKey(@"交通银行"),LocalizationKey(@"中信银行"),LocalizationKey(@"华夏银行"),LocalizationKey(@"中国民生银行"),LocalizationKey(@"广发银行"),LocalizationKey(@"平安银行"),LocalizationKey(@"兴业银行"),LocalizationKey(@"上海浦东发展银行"),LocalizationKey(@"浙商银行"),LocalizationKey(@"渤海银行"),LocalizationKey(@"恒丰银行"),LocalizationKey(@"花旗银行"),LocalizationKey(@"渣打银行"),LocalizationKey(@"汇丰银行"),LocalizationKey(@"中国光大银行"),LocalizationKey(@"上海银行"),LocalizationKey(@"江苏银行"),LocalizationKey(@"重庆银行"),LocalizationKey(@"天津银行"),LocalizationKey(@"厦门银行"),LocalizationKey(@"城市商业银行"),LocalizationKey(@"农村商业银行"),LocalizationKey(@"徽商银行")];
