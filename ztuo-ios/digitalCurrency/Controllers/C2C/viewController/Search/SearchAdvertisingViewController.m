...
- (IBAction)buttonClick:(UIButton *)sender {
    if (sender.tag == 1){
        //选择币种
        NSLog(LocalizationKey(@"选择币种"));
    }else if (sender.tag == 2){
        //所在地
        NSLog(LocalizationKey(@"所在地"));
    }else if (sender.tag == 3){
        //付款方式
        NSLog(LocalizationKey(@"付款方式"));
    }else if (sender.tag == 4){
        //货币类型
        NSLog(LocalizationKey(@"货币类型"));
    }else if (sender.tag == 5){
        //搜索
        NSLog(LocalizationKey(@"搜索"));
    }else{
      //其他
        NSLog(LocalizationKey(@"其他"));
    }
}
