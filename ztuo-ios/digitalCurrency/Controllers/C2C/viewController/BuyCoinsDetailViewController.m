...
-(void)getBuyAdvertiseInfo{
    ...
    [C2CNetManager buyOrSelladvertiseInfoForid:_advertisingId CompleteHandle:^(id resPonseObj, int code) {
        NSLog(LocalizationKey(@"获取购买的广告信息 --- %@"),resPonseObj);
...
-(void)setNavBarUI{
    ...
    [rightButton2 setTitle:LocalizationKey(@"中国") forState:UIControlStateNormal];
