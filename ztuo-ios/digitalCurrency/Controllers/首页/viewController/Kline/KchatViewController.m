...
@interface KchatViewController ()<Y_StockChartViewDataSource,SocketDelegate>
{
...
-(void)getExchangeNumber{
    [HomeNetManager latesttradeWithsymbol:self.symbol withSizeSize:20 CompleteHandle:^(id resPonseObj, int code) {
        ...
        NSLog(NSLocalizedString(@"获取成交记录数据--%@", nil),resPonseObj);
...
-(void)getplatefull{
    ...
    [HomeNetManager platefullWithsymbol:self.symbol CompleteHandle:^(id resPonseObj, int code) {
        [EasyShowLodingView hidenLoding];
        //         NSLog(NSLocalizedString(@"获取盘口信息数据--%@", nil),resPonseObj);
...
- (Y_StockChartView *)stockChartView
{
    if(!_stockChartView) {
        _stockChartView = [Y_StockChartView new];
        _stockChartView.itemModels = @[
            [Y_StockChartViewItemModel itemModelWithTitle:NSLocalizedString(@"指标", nil) type:Y_StockChartcenterViewTypeOther],
            [Y_StockChartViewItemModel itemModelWithTitle:NSLocalizedString(@"分时", nil) type:Y_StockChartcenterViewTypeTimeLine],
            [Y_StockChartViewItemModel itemModelWithTitle:NSLocalizedString(@"1分", nil) type:Y_StockChartcenterViewTypeKline],
            [Y_StockChartViewItemModel itemModelWithTitle:NSLocalizedString(@"5分", nil) type:Y_StockChartcenterViewTypeKline],
            [Y_StockChartViewItemModel itemModelWithTitle:NSLocalizedString(@"1小时", nil) type:Y_StockChartcenterViewTypeKline],
            [Y_StockChartViewItemModel itemModelWithTitle:NSLocalizedString(@"1天", nil) type:Y_StockChartcenterViewTypeKline],
            [Y_StockChartViewItemModel itemModelWithTitle:NSLocalizedString(@"15分", nil) type:Y_StockChartcenterViewTypeKline],
            [Y_StockChartViewItemModel itemModelWithTitle:NSLocalizedString(@"30分钟", nil) type:Y_StockChartcenterViewTypeKline],
            [Y_StockChartViewItemModel itemModelWithTitle:NSLocalizedString(@"1周", nil) type:Y_StockChartcenterViewTypeKline],
            [Y_StockChartViewItemModel itemModelWithTitle:NSLocalizedString(@"1月", nil) type:Y_StockChartcenterViewTypeKline],
        ];
        _stockChartView.backgroundColor = [UIColor orangeColor];
...
//                NSLog(NSLocalizedString(@"缩略行情 -- %@", nil),dic);
        ...
        NSLog(NSLocalizedString(@"取消订阅K线缩略行情消息", nil));
        
    }else if (cmd==PUSH_EXCHANGE_KLINE){
        
        NSLog(NSLocalizedString(@"订阅K线消息", nil));
        ...
        if (self.tradeNumberArray.count==DataRow) {
            ...
            NSLog(NSLocalizedString(@"成交记录 -- %@", nil),dic);
        ...
        NSLog(NSLocalizedString(@"深度图--%@", nil),dic);
        ...
        NSLog(NSLocalizedString(@"取消K线消息", nil));
        
    }else{
        
    }
    //    NSLog(NSLocalizedString(@"K线消息-%@--%d", nil),endStr,cmd);
}
