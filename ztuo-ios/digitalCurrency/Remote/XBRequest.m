...
- (void)postDataWithUrl:(NSString *)url Parameter:(NSDictionary *)param ResponseObject:(void(^)(NSDictionary *responseResult))responseObjects{
    ...
    if (!ISEMPTY_S(userName)) {
        NSString*md5Str= [MD5 md5:[NSString stringWithFormat:@"%@%@",[keychianTool readUserUUID], userName]];
        
        [sessionManager.requestSerializer setValue:md5Str forHTTPHeaderField:@"access-auth-token"];
//        NSLog(@"~~~~~~~xbrequest %@  %@  %@  %@  %@", firstName, md5Str, userName,[keychianTool readUserUUID],[keychianTool getUserNameAndPasswordFromKeychain]);
    }
...
//    [sessionManager.requestSerializer setValue:md5Str forHTTPHeaderField:@"access-auth-token"];
    ...
    sessionManager.responseSerializer.acceptableContentTypes = [NSSet setWithObjects:@"application/json",@"text/json",@"text/html",@"text/javascript",@"application/x-www-form-urlencoded"];
...
- (void)getDataWithUrl:(NSString *)url Parameter:(NSDictionary *)param ResponseObject:(void(^)(NSDictionary *responseResult))responseObjects{
    ...
    NSString *userName = [YLUserInfo getLoginAccount];
    if (!ISEMPTY_S(userName)) {
        NSString*md5Str= [MD5 md5:[NSString stringWithFormat:@"%@%@%@",[keychianTool readUserUUID],[keychianTool getUserNameAndPasswordFromKeychain], userName]];
...
//    [sessionManager.requestSerializer setValue:md5Str forHTTPHeaderField:@"access-auth-token"];
    ...
    sessionManager.requestSerializer.timeoutInterval = 30.f;
    sessionManager.responseSerializer.acceptableContentTypes = [NSSet setWithObjects:@"application/json",@"text/json",@"text/html",@"text/javascript",@"text/plain",@"image/png",@"application/x-www-form-urlencoded"];
...
- (void)putDataWithUrl:(NSString *)url Parameter:(NSDictionary *)param ResponseObject:(void(^)(NSDictionary *responseResult))responseObjects{
    ...
    sessionManager.responseSerializer.acceptableContentTypes = [NSSet setWithObjects:@"application/json",@"text/json",@"text/html",@"text/javascript"];
